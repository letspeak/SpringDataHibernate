...
<h1><spring:message code="employee.edit.page.title"/></h1>
<div>
    <form:form action="/employee/edit" commandName="employee" method="POST">
        <form:hidden path="id"/>
        <div>
        ...
        <div>
            <input type="submit" value="<spring:message code="employee.edit.page.submit.label"/>"/>
        </div>
    </form:form>
</div>
</body>
